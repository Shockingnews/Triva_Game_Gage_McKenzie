...
namespace Trivia_Game_Gage_McKenzie
{
    internal class Program
    {
        ...
        static List<string> questions = new List<string>() { "Question 1#: what causes an infinty loop? ", "Question 2#: the most helpful code to use when making a map is?", "Question 3#: what is the right variable for a single letter?", "Question 4#: What programming language are we using?", "Question 5#: What is the symbol for multiplying?", "Question 6#: How do you make a string public?", "Question 7#: whats the quickest way to add?", "Question 8#: how to stop While Loop? while(collecting)", "Question 9#: What will it output: if(5 == num){num = 0}", "Question 10#: how many questions were there?"};
